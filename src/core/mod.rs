...
pub use extraction::{
    count_hits, extract_dual_strand_into, extract_into, extract_into_with_positions,
    extract_minimizer_set, extract_strand_minimizers, get_paired_minimizers_into, Strand,
    StrandMinimizers,
};
